...
export function defaultState():AppState{
  return {
    version:'2.0.0-beta.1',progress:[],sessions:[],questionSessions:[],errors:[],reviews:[],flashcards:[],questionBank:[],simulations:[],discursives:[],practicals:[],
...
export function exportBackup(state:AppState){
  ...
  const blob=new Blob([JSON.stringify({...next,exportedAt:new Date().toISOString(),appVersion:'2.0.0-beta.1'},null,2)],{type:'application/json'})
